...
public class MainMenu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridArray.add(new Item("Eggs Benedict", R.drawable.eggs, new Integer[]{}, 1, "40"));
        gridArray.add(new Item("Tomato Tart", R.drawable.tomato_tart, new Integer[]{}, 2, "25"));
        gridArray.add(new Item("Coconut Pie", R.drawable.coconut_cheese, new Integer[]{}, 1, "50"));
        gridArray.add(new Item("Cheese Cigars", R.drawable.goat_cheese, new Integer[]{}, 1, "40"));


        gridView = (GridView) findViewById(R.id.gridview);
        recipeGridViewAdapter = new RecipeGridViewAdapter(this, R.layout.main_menu_elem, gridArray);
